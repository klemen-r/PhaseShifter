...
const settingItems: SettingItem[] = [
  { id: "phaseWindow", label: "Phase Window", category: "Chart", keywords: ["phase", "window", "donchian", "period"] },
  { id: "showMidpoint", label: "Show Midpoint Line", category: "Chart", keywords: ["midpoint", "line", "show", "hide", "donchian"] },
  { id: "clusterOpacity", label: "Cluster Opacity", category: "Clusters", keywords: ["cluster", "opacity", "transparent", "alpha"] },
  { id: "clusterBullish", label: "Cluster Bullish Color", category: "Clusters", keywords: ["cluster", "bullish", "green", "up", "color"] },
  { id: "clusterBearish", label: "Cluster Bearish Color", category: "Clusters", keywords: ["cluster", "bearish", "red", "down", "color"] },
  { id: "clusterBorderColor", label: "Cluster Border Color", category: "Clusters", keywords: ["cluster", "border", "color", "stroke"] },
  { id: "clusterBorderStyle", label: "Cluster Border Style", category: "Clusters", keywords: ["cluster", "border", "style", "solid", "dashed", "none"] },
  { id: "lineColor", label: "Midpoint Line Color", category: "Midpoint", keywords: ["line", "color", "midpoint", "donchian"] },
  { id: "bgUpColor", label: "Up Background Color", category: "Midpoint", keywords: ["background", "up", "bullish", "green", "color"] },
  { id: "bgDownColor", label: "Down Background Color", category: "Midpoint", keywords: ["background", "down", "bearish", "red", "color"] },
  { id: "transparency", label: "Background Transparency", category: "Midpoint", keywords: ["transparency", "alpha", "opacity", "background"] },
  { id: "candleUp", label: "Candle Up Color", category: "Candles", keywords: ["candle", "up", "bullish", "green", "color"] },
  { id: "candleDown", label: "Candle Down Color", category: "Candles", keywords: ["candle", "down", "bearish", "red", "color"] },
  { id: "candleBorderUp", label: "Candle Border Up", category: "Candles", keywords: ["candle", "border", "up", "bullish", "color"] },
  { id: "candleBorderDown", label: "Candle Border Down", category: "Candles", keywords: ["candle", "border", "down", "bearish", "color"] },
];
...
export function ExtraSettingsDialog({
  ...
  const getCurrentSettings = useCallback((): ChartSettingsData => ({
    phaseAmount,
    showMidpoint,
    clusterOpacity,
    clusterBullishColor,
    ...
    phaseAmount, showMidpoint, clusterOpacity, clusterBullishColor, clusterBearishColor,
    clusterBorderColor, clusterBorderStyle, lineColor, bgUpColor, bgDownColor,
    transparency, candleUpColor, candleDownColor, candleBorderUp, candleBorderDown,
  ]);
      ...
      <DialogContent className="border-zinc-800 bg-zinc-950/95 backdrop-blur-lg text-zinc-100 max-w-lg">
        ...
        <div className="space-y-3 border border-zinc-800 rounded-lg p-3 bg-zinc-900/40">
          ...
          <div className="flex gap-2">
            ...
            >
              {saveSuccess ? <Check className="h-4 w-4 text-green-500" /> : <Save className="h-4 w-4" />}
            </Button>
          </div>
        ...
        <div className="max-h-[50vh] space-y-4 overflow-y-auto pr-1">
            ...
            <>
              ...
              {isVisible("showMidpoint") && (
                <div className="flex items-center justify-between rounded-lg border border-zinc-800 bg-zinc-900/60 p-3">
                  <div>
                    <span className="text-sm text-zinc-200">Show Midpoint Line</span>
                    <p className="text-xs text-zinc-500">Display the Donchian midpoint.</p>
                  </div>
                  <Switch checked={showMidpoint} onCheckedChange={setShowMidpoint} />
                </div>
              )}
              {isCategoryVisible("Chart") && <Separator className="bg-zinc-800" />}
            </>
          )}
          ...
          {isCategoryVisible("Clusters") && (
            <>
              ...
              {isVisible("clusterOpacity") && (
                <div className="space-y-2">
                  <Label className="text-zinc-200 flex items-center justify-between">
                    Cluster Opacity
                    <span className="text-xs text-zinc-400">{liveClusterOpacity}%</span>
                  </Label>
                  <Input
                    type="range"
                    min={10}
                ...
                {isVisible("clusterBorderStyle") && (
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) => setClusterBorderStyle(e.target.value as "solid" | "dashed" | "none")}
              ...
              {isCategoryVisible("Clusters") && <Separator className="bg-zinc-800" />}
            </>
          )}
          ...
          {isCategoryVisible("Midpoint") && (
            <>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                {isVisible("transparency") && (
                  <div className="space-y-2">
                    <Label className="text-zinc-200 flex items-center justify-between">
                      Transparency
                      <span className="text-xs text-zinc-400">{liveTransparency}%</span>
                    </Label>
                    <Input
                      type="range"
                      min={0}
              ...
              {isCategoryVisible("Midpoint") && <Separator className="bg-zinc-800" />}
            </>
          )}
